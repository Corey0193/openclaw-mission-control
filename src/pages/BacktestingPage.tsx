				...
				<header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
					<div>
						...
						<p className="text-sm text-slate-500 mt-1">
							Analyze strategy performance, hyperparameter tuning, and
							...
							<div className="p-4 grid grid-cols-2 gap-4">
								<div>
									...
									<p className="text-lg font-bold text-emerald-600">
										+${latestResults.metrics.train_pnl.toFixed(2)}
									</p>
								</div>
								<div>
									<p className="text-xs text-slate-500 font-medium">Win Rate</p>
									<p className="text-lg font-bold text-slate-800">
										{(latestResults.metrics.win_rate * 100).toFixed(1)}%
									</p>
								</div>
								<div>
									<p className="text-xs text-slate-500 font-medium">
									...
									<p className="text-lg font-bold text-rose-600">
										{(latestResults.metrics.max_dd * 100).toFixed(1)}%
									</p>
								</div>
								<div>
									<p className="text-xs text-slate-500 font-medium">Trades</p>
									<p className="text-lg font-bold text-slate-800">
										{latestResults.metrics.trade_count}
									</p>
								</div>
							</div>
						</div>
									...
									<tbody className="divide-y divide-slate-100">
										<tr>
											...
											<td className="py-3 px-4 font-bold text-emerald-600">
												+${latestResults.windows.train.pnl.toFixed(2)}
											</td>
											<td className="py-3 px-4 font-bold text-emerald-600">
												+${latestResults.windows.validate.pnl.toFixed(2)}
											</td>
											<td className="py-3 pl-4 font-bold text-emerald-600">
												+${latestResults.windows.test.pnl.toFixed(2)}
											</td>
										</tr>
										<tr>
											<td className="py-3 pr-4 font-medium text-slate-700">
											...
											<td className="py-3 px-4 text-slate-800">
												{latestResults.windows.train.sharpe.toFixed(3)}
											</td>
											<td className="py-3 px-4 text-slate-800">
												{latestResults.windows.validate.sharpe.toFixed(3)}
											</td>
											<td className="py-3 pl-4 text-slate-800">
												{latestResults.windows.test.sharpe.toFixed(3)}
											</td>
										</tr>
										<tr>
											<td className="py-3 pr-4 font-medium text-slate-700">
											...
											<td className="py-3 px-4 text-rose-600">
												{(latestResults.windows.train.maxDd * 100).toFixed(1)}%
											</td>
											<td className="py-3 px-4 text-rose-600">
												{(latestResults.windows.validate.maxDd * 100).toFixed(
													1,
												)}
												%
											</td>
											<td className="py-3 pl-4 text-rose-600">
												{(latestResults.windows.test.maxDd * 100).toFixed(1)}%
											</td>
										</tr>
										<tr>
											<td className="py-3 pr-4 font-medium text-slate-700">
											...
											<td className="py-3 px-4 text-slate-800">
												{latestResults.windows.train.trades}
											</td>
											<td className="py-3 px-4 text-slate-800">
												{latestResults.windows.validate.trades}
											</td>
											<td className="py-3 pl-4 text-slate-800">
												{latestResults.windows.test.trades}
											</td>
										</tr>
										<tr>
											<td className="py-3 pr-4 font-medium text-slate-700">
											...
											<td className="py-3 px-4 text-slate-800">
												{(latestResults.windows.train.winRate * 100).toFixed(1)}
												%
											</td>
											<td className="py-3 px-4 text-slate-800">
												{(latestResults.windows.validate.winRate * 100).toFixed(
													1,
												)}
												%
											</td>
											<td className="py-3 pl-4 text-slate-800">
												{(latestResults.windows.test.winRate * 100).toFixed(1)}%
											</td>
										</tr>
									</tbody>
								</table>
							...
							<div className="flex-1 flex items-center justify-center bg-slate-50 relative">
								...
								<div className="z-10 text-center space-y-2">
									...
									<p className="text-xs text-slate-400">
										Run optimization to refresh equity data.
									</p>
								</div>
							</div>
						</div>
