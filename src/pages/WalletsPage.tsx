							...
							<table className="w-full text-sm">
								<thead>
									<tr className="bg-muted/30 border-b border-border text-[11px] font-bold text-muted-foreground tracking-widest uppercase">
										...
										<th className="text-left px-6 py-4">Perf. Score</th>
									...
									{!wallets ? (
										...
										filteredWallets.map((w) => (
											...
											>
												...
												<td className="px-6 py-4">
													<PerformanceScore score={w.performanceScore} />
												</td>
												<td className="px-6 py-4">
												...
												<td className="px-6 py-4 text-right">
													<a
														...
														target="_blank"
														rel="noopener noreferrer"
														className="inline-flex items-center gap-1.5 text-[11px] font-bold text-[var(--accent-orange)] hover:underline"
													>
														PROFILE
